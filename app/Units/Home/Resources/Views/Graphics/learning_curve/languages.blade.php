      ...
      <div class="col-md-12">
          <div class="card-graphic" id="about">
            <div class="header">
              ...
              <div class="content">
                  Com base nos dados gerados pela curva de aprendizado, todos os pontos de <strong>todas as linguagens</strong> foram analisados, procurando um padrão de comportamento entre si. Utilizando a regressão linear a qual foi aplicada neste gráfico, você conseguirá identificar uma tendência perante essas linguagens de um determinado período.
              </div>
          </div>
      </div>
    </div>
