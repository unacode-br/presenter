...
<head>
    ...
    <link href="app/resources/assets/assets-home/css/landing-page.css" rel="stylesheet"/>
    <!--     Fonts and icons     -->
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400,300' rel='stylesheet' type='text/css'>
    <link href="app/resources/assets/assets-home/css/pe-icon-7-stroke.css" rel="stylesheet" />
</head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1 hidden-xs">
                    <img src="img/showcases/showcase-1/iphones.png"/ style="top:-50px">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6">
                    <div id="description-carousel" class="carousel fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item">
                                <img src="img/showcases/showcase-1/examples/home_3.jpg" alt="">
                            </div>
                            <div class="item active">
                                <img src="img/showcases/showcase-1/examples/home_2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="img/showcases/showcase-1/examples/home_1.jpg" alt="">
                            </div>
                        </div>
...
<script src="resources/assets-home/js/jquery-1.10.2.js" type="text/javascript"></script>
<script src="resources/assets-home/js/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>
<script src="resources/assets-home/js/bootstrap.js" type="text/javascript"></script>
<script src="resources/assets-home/js/awesome-landing-page.js" type="text/javascript"></script>
</html>